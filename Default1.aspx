...
<br />
&nbsp; <img src="image1/m%20images/e12.jpg" width ="500PX" alt ="" height ="500PX" />  
...
<h2> Movie Name: <asp:TextBox ID ="t1" runat ="server" Text ="Annya" ></asp:TextBox></h2>
    ...
    <br /><br />
     <a href ="payment1.aspx" >
        <asp:Button ID="Button2" runat="server" Text="book" 
            OnClick="book2_click" Height="49px" Width="165px"/></a>
             <br /><br />
