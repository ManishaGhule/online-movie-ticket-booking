...
<br />
&nbsp; <img src="image1/m%20images/saaho.jpg" width ="500px" alt ="" height ="500px" />
</asp:Panel> 
<asp:Panel ID ="p2" runat ="server" EnableViewState ="true" Width ="500PX" CssClass ="demo v">
<h2> Movie Name :<asp:TextBox ID ="t1" runat ="server" Text ="saho" ></asp:TextBox> </h2>
<br />
    ...
    <br /><br />
     <a href ="payment1.aspx" >
        <asp:Button ID="Button2" runat="server" Text="book" 
            OnClick="book3_click" Height="49px" Width="165px"/></a>
             <br /><br />
